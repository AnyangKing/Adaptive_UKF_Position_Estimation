...
def crop_direct_arrival(received,cfg,window_s,pre_s=0.0001,toas=None):
    if toas is None:
...
def estimate_gated_srp(received,cfg,window_s,toas=None):
    cropped,toas=crop_direct_arrival(received,cfg,window_s,toas=toas)
