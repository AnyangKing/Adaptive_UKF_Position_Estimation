...
% Absorb small overfull boxes from long inline math in narrow IEEE columns.
...
$1.5^2~\mathrm{(m/s)^2}\,I_3)$, and a fixed base measurement covariance built from
0.03~m TOA-range, 0.025~m per-sensor TDOA, and $2.0^{\circ}$ DOA standard deviations.
