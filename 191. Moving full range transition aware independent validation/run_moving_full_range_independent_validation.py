"""Moving-target 0--1000 m independent validation for transition-aware Adaptive-R."""
...
def run(max_workers: int = 6) -> dict[str, Any]:
    ...
    payload = {
        "config": {
            "stage": "moving_full_range_independent_validation",
            ...
            "claim_boundary": "independent simulation validation; not real-water validation",
        },
        "summary": summarize(rows),
        "trials": rows,
    }
    (HERE / "moving_full_range_independent_validation.json").write_text(
